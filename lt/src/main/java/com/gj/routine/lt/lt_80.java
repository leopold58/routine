 ...
 *                  解释：函数应返回新长度 length = 7, 并且原数组的前五个元素被修改为0, 0, 1, 1, 2, 3, 3不需要考虑数组中超出新长度后面的元素。
 *                提示：
 *                  1 <= nums.length <= 3 * 104
 *                  -104 <= nums[i] <= 104
 *                  nums 已按升序排列
...
public class lt_80 {
    ...
    public static void main(String[] args) {
        System.out.println("请输入一串数字，中间采用逗号隔开：");
